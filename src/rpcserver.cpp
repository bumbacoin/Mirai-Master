...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MRI features */
        {"mirai", "masternode", &masternode, true, true, false},
        {"mirai", "masternodelist", &masternodelist, true, true, false},
        {"mirai", "mnbudget", &mnbudget, true, true, false},
        {"mirai", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"mirai", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mirai", "mnsync", &mnsync, true, true, false},
        {"mirai", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"mirai", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use miraid, or the -server option to mirai-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:14441/\n";
}
