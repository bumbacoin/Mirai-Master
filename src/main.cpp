...
#if defined(NDEBUG)
#error "MRI cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "MRI Signed Message:\n";
...
bool AddOrphanTx(const CTransaction& tx, NodeId peer)
{
    ...
    // 5,000 orphans, each of which is at most 5,000 bytes big is
...
{
    //Nos dimos cuenta que el block value no es el 90%, sino el 100%.
    int64_t ret = (blockValue) * .7;
    return ret;
}
