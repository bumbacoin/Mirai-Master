...
const QString BITCOIN_IPC_PREFIX("mirai:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/mirai-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/mirai-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/mirai-paymentrequest";
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // mirai: URI
    {
        ...
        } else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient)) {
                ...
                emit message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid MRI address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
