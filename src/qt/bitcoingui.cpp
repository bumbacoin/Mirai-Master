                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MRI-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MRI address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mirai: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MRI Core"), this);
    aboutAction->setStatusTip(tr("Show information about MRI Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MRI"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MRI addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MRI addresses"));
    ...
    openAction->setStatusTip(tr("Open a MRI: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MRI Core help message to get a list with possible MRI command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MRI Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MRI network", "", count));
}
...
{
    QString strTitle = tr("MRI Core"); // default title
