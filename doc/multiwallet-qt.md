...
In order to support loading of multiple wallets in mirai-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mirai.cpp.
...
Changes to mirai.cpp
----------------------
mirai.cpp is the entry point into mirai-qt, and as such, will require some minor modifications to provide hooks for
